...
export default function Nav() {
  ...
  return (
    <nav className={`shadow-lg fixed w-full transition-transform duration-300 bg-white h-14 px-4 md:px-16 flex items-center justify-between z-50`}>
      ...
      <ul className="hidden md:flex space-x-6 text-blue-700">
        ...
        <li><Link href="#actionplan" className="hover:underline">Action Plan</Link></li>
